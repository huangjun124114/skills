...
本目录收集所有 skill。每个子目录是一个独立 skill，入口均为 `SKILL.md`。

## 新增 skill 约定

1. 目录名与 `SKILL.md` frontmatter 的 `name` 字段保持一致，使用 kebab-case
...
| [html-deploy](./html-deploy/) | 4 |
| [humanizer](./humanizer/) | 3 |
| [ima-skills](./ima-skills/) | 5 |
| [industry-research-6](./industry-research-6/) | 1 |
| [library-page-archive](./library-page-archive/) | 1 |
| [libtv-cli](./libtv-cli/) | 44 |
| [marketing-demand-translator](./marketing-demand-translator/) | 5 |
